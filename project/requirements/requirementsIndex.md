...
- [009 — Banking module](features/009-bankingModule.md) — Banking Core aggregates, identity reuse and typed capture implemented; money movements, payment arrangements, workflows and projections remain
